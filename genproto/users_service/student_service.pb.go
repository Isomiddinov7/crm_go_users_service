...
type Student struct {
	...
	CourceCount int64  `protobuf:"varint,5,opt,name=cource_count,json=courceCount,proto3" json:"cource_count,omitempty"`
	TotalSum    string `protobuf:"bytes,6,opt,name=total_sum,json=totalSum,proto3" json:"total_sum,omitempty"`
